        ...
        <div className="right_container">
          <div className="left_side">
            ...
            <div className="center_boxes">
              ...
              <img
                id="arrow"
                src="https://image.flaticon.com/icons/svg/122/122636.svg"
                alt="right arrow"
              />
              <img
                src="https://image.flaticon.com/icons/svg/948/948593.svg"
                alt="mailbox"
              />
              <img
                id="arrow"
              ...
              />
              <img
                src="https://image.flaticon.com/icons/svg/1027/1027618.svg"
                alt="thumbs up"
              />
            </div>
            <div className="center_boxes">
              <h3>
                Begin by completing the form or take a photo of your old ID/DL
              </h3>
            </div>
